            ...
            <div class="row">
                <div class="col">
                    <table>
                        ...
                        <tr>
                            <td class="value-cell">เวลาที่ไลน์
                                stop:&nbsp;{{ $item->CA_PROD_TMPBF }}-{{ $item->CA_PROD_TMPBL }}</td>
                            @if (!empty($item->CA_PROD_IMAGE))
                                <td class="value-cell" rowspan="3" colspan="2"><img
                                        src="{{ asset('public/images_ca/' . $item->CA_PROD_IMAGE) }}"
                            ...
                            @else
                                <td class="value-cell" rowspan="3" colspan="2"><img
                                        src="{{ asset('public/image/No-image.jpg') }}" alt="Document Image"
                        ...
                        <tr>
                            <td class="value-cell">NG Q'ty / NG Rate :&nbsp;{{ $item->CA_PROD_NG }} /
                                {{ $item->CA_PROD_RATE }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="value-cell" rowspan="2" style="font-size: 22px;">PIC
                                Date:&nbsp;{{ date('d-M-Y', strtotime($item->CA_CASEREC_LSTDT)) }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="label-cell" rowspan="2">รายชื่อผู้อนุมัติ<br>Production CA</td>
                            <td class="label-cell text-center">Leader</td>
                            <td class="label-cell text-center">Supervisor</td>
                            <td class="label-cell text-center">Manager</td>
                            ...
                            @foreach ($recapp as $app)
                                ...
                                @foreach ($user as $name)
                                    @if ($app->CA_EMPID_APPR == $name->MUSR_ID)
                                        <td class="value-cell" style="text-align: center; color: #347928;">
                                            {{ $name->MUSR_NAME }}</td>
                                        @php
                                            $name_status = true;
                                        @endphp
